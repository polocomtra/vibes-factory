...
import { Bot, CircleAlert, Clock3, LoaderCircle, Plus, Search, Sparkles } from "lucide-react";
...
import { createSession, fetchSessions, type Session } from "../../lib/runtime";
...
function SessionItem({ session, selected, onSelect, onContinue }: { session: Session; selected: boolean; onSelect: () => void; onContinue: () => void }) {
  return (
