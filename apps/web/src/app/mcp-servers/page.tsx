...
export default function MCPServersPage() {
    ...
    const [selectedServer, setSelectedServer] = useState<MCPServer | null>(
        null,
    );
    ...
    const [bulkImportEntries, setBulkImportEntries] = useState<
        BulkImportEntry[]
    >([]);
    ...
    const [confirmingServerId, setConfirmingServerId] = useState<string | null>(
        null,
    );
    ...
    async function submitServer(event: FormEvent) {
        ...
        if (
            ...
            setFormError(
                "Choose a Secret Store credential for every custom header.",
            );
            setBusy(null);
            return;
        }
            ...
            <div className="pagination-page mcp-page">
                <header className="page-header mcp-page-header">
                    <div>
                        ...
                        <h1>MCP Servers</h1>
                        <p>
                            Connect trusted Model Context Protocol servers and
                            promote their tools into immutable agent
                            capabilities.
                        </p>
                    </div>
                    <button
                ...
                <section className="mcp-server-grid" aria-label="MCP servers">
                    {servers.length === 0 ? (
                        <div className="mcp-empty-state">
                            ...
                            <p>
                                Connect your first Streamable HTTP server to
                                discover tools and make them available to your
                                agents.
                            </p>
                            <button
                                className="button primary-button"
                            ...
                            <small>
                                Streamable HTTP · Credential Vault supported
                            </small>
                        </div>
                    ) : (
                                    ...
                                    >
                                        ...
                                        <div className="mcp-card-copy">
                                            <div className="mcp-card-title">
                                                <h2>{server.name}</h2>
                                                <span
                                                    className={`status-badge ${state.className}`}
                                                >
                                                    <span />
                                                    {state.label}
                                                </span>
                ...
                <PaginationControls
                    ...
                    ariaLabel="MCP servers pagination"
                />
                    ...
                    >
                        ...
                        <div className="mcp-detail-actions">
                            <button
                                ...
                                onClick={() =>
                                    void runServerAction("test", selectedServer)
                                }
                            >
                                {panelAction === "test" ? (
                                    <LoaderCircle
                            ...
                            {modal === "create" ? (
                                <form onSubmit={submitServer}>
                                    ...
                                    <p className="field-helper">
                                        Use a Streamable HTTP endpoint. Secrets
                                        stay in the credential vault.
                                    </p>
                                    <label>
                                        Name
                                        <input
                                    ...
                                    >
                                        <div className="mcp-custom-headers-heading">
                                            <div>
                                                ...
                                                <p>
                                                    ...
                                                    credential for each header
                                                    value. Custom headers can be
                                        ...
                                        {form.customHeaders.length === 0 ? (
                                            <p className="mcp-custom-headers-empty">
                                                Add a header name and choose the
                                                Secret Store entry that supplies
                                                its value, for example{" "}
                                                <code>x-instance</code> →{" "}
                                                <code>
                                ...
                                <form onSubmit={submitImport}>
                                    ...
                                    <h2 id="mcp-modal-title">
                                        Import{" "}
                                        {selectedTool?.title ||
                                            selectedTool?.remote_name}
                                    </h2>
                                    <p className="field-helper">
                                        This creates an immutable ToolVersion.
                                        Re-import after schema drift to create a
                                        new version.
                                    </p>
                                    <label>
                                        Tool name
                    ...
                    >
                        ...
                        >
                            ...
                            <form onSubmit={submitBulkImport}>
                                ...
                                <p className="field-helper">
                                    Review the display name for every tool
                                    before creating immutable ToolVersions.
                                    Slugs are generated automatically from each
                                    name.
                                </p>
                                ...
                                <div className="bulk-import-list">
                                    {bulkImportEntries.map((entry, index) => (
                                        ...
                                        >
                                            ...
                                            <label
                                                htmlFor={`bulk-tool-name-${entry.tool.id}`}
                                            >
                                                Tool name
                                                <input
